...
B_TOKEN = os.getenv("5103541089:AAH77obZwMXGQeo_LLbFfVYEy-DSx-1Wi4Q") # Kullanıcı'nın Bot Tokeni
API_ID = os.getenv("14672969") # Kullanıcı'nın Apı Id'si
API_HASH = os.getenv("67819474b2c4ee77b04e8ec490ad5703") # Kullanıcı'nın Apı Hash'ı
OWNER_ID = os.getenv("5030750958").split() # Botumuzda Yetkili Olmasini Istedigimiz Kisilerin Idlerini Girecegimiz Kisim
